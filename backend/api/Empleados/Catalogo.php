    ...
    switch ($method) {
        case "GET":
           ...
           $query = "SELECT DISTINCT(t1.Idpersonal) as IdPersonal, t1.NoEmpleado, 
                    ...
                    t1.Email, t1.Contacto, t1.IdSupervisor, t1.TipoSangre, t1.FechaCreación, 
                    CASE WHEN t2.IdVehiculo IS NULL THEN 'NO' ELSE 'SI' END  as TieneVehiculo, t1.NSS, t1.FechaCreacion,
                    CASE WHEN t1.EsSupervisor <>1 THEN 'NO' ELSE 'SI' END  as EsSupervisor
