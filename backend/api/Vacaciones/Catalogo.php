    ...
    switch ($method) {
        case "GET":
           ...
           $query = "SELECT DISTINCT(t1.Idpersonal) as IdPersonal, t1.NoEmpleado, 
                    ...
                    t1.Email, t1.Contacto, t1.IdJefeInmediato, t1.TipoSangre, t1.FechaCreación,  t1.NSS, t1.FechaCreacion,
                    CASE WHEN t1.EsJefeInmediato <>1 THEN 'NO' ELSE 'SI' END  as EsJefeInmediato,TipoSangre,FechaIngreso
